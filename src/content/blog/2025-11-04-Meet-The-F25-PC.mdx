...
<div className="grid grid-cols-2 gap-4 my-6 max-w-2xl mx-auto">
  <img src="public/F25PCimage/Andrew0014 - Andrew Wolf.jpg" alt="Andrew" className="rounded-lg shadow-md w-full max-h-40 object-cover" />
</div>
...
### Annika Weir
<div className="grid grid-cols-2 gap-4 my-6 max-w-2xl mx-auto">
  <img src="/F25PCimage/theta_tau_photo_2_annika_weir.jpg" alt="Annika" className="rounded-lg shadow-md w-full max-h-40 object-cover" />
</div>
