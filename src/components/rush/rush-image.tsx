...
export default function RushPage() {
  const activities = [
    ...
    { title: "Professional Development", description: "Connect with successful θT alumni. Gain skills and connections to jumpstart your career. Elevate your resume, sharpen your interview skills, and unlock doors to internships and jobs that set you apart.", image: "/fall24elections.jpg?height=400&width=600&text=Pro+Dev" },
    ...
    { title: "Career Fairs", description: "Explore career building opportunities at our exclusive career fair workshops.", image: "/20240428_211420_7565D5-768x1024.jpeg?height=400&width=600&text=Career+Fair" },
