    ...
    return (
        <section className="relative">
            ...
            <div className="relative bg-[#062056] min-h-screen flex items-center justify-center overflow-hidden py-20">
                <div className="container flex flex-col md:flex-row items-center gap-8 relative z-10">
                    {/* Content Section */}
                    <div className="flex flex-col items-center md:items-start text-center md:text-left max-w-lg md:flex-shrink-0">
